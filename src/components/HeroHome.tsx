  ...
  return (
    <section>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        {/* Hero content */}
        <div className="relative pb-10 md:pt-16 md:pb-16">
          {/* Section header */}
          <div className="max-w-5xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4" data-aos="fade-up"> {name} </h1>
            ...
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              ...
              <div data-aos="fade-up" data-aos-delay="600">
                <a className="btn text-white rounded-md bg-gray-700 hover:bg-gray-800 w-full sm:w-auto sm:ml-4" href="#0">
                  {cta2}
                </a>
              </div>
            </div>
          ...
          <div>
            <div className="relative flex justify-center items-center" data-aos="fade-up" data-aos-delay="200">
              <img className="mx-auto rounded-3xl" src={image} width="850" alt="Hero" />
              {/* <a
